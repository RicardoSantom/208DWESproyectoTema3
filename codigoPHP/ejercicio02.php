...
<html lang="en">
    ...
    <body>
        ...
        <main>
            <article>
                <h3>Enunciado: 02.Inicializar y mostrar una variable heredoc</h3>
                <?php
                $cadena = <<<ESCAPE
         <h4>Esta cadena <br>
        sirve para probar heredoc</h4>
        ESCAPE;
                print $cadena;
                $cadena2 = <<<TERMINAR
        <h5>Esta segunda cadena <br>
        sirve para probar heredoc<br>
        con un formato diferente:</h5>
                    <p>En esta ocasión estamos probando una 
                    etiqueta html de párrafo</p>
                    <p>Si queremos hacer un salto de línea tenemos que recurrir a una etiqueta html ='<'br'>'<br>
                    o no nos formateará como queremos</p>
        TERMINAR;
                print $cadena2;
                ?>
            </article>
