...
<html lang="en">
    <head>
        ...
        <title>Ejercicio 021 Tema3</title>
    ...
    <body>
        ...
        <main>
            <article>
                <h3>Enunciado: Construir un formulario para recoger un cuestionario realizado a una persona y enviarlo a una página Tratamiento.php para que muestre
        las preguntas y las respuestas recogidas.</h3>
                <h4 style="color:orange">Código ejercicio021.php</h4>
                <?php echo highlight_file("../codigoPHP/ejercicio021.php");?>
                <h4 style="color:orange">Código Tratamiento.php</h4>
                <?php echo highlight_file("../core/Tratamiento.php");?>
            </article>
        </main>
        <footer>
