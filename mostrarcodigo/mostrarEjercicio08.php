...
<html lang="en">
    <head>
        ...
        <title>Ejercicio 08 Tema 3</title>
        <!-- Última actualización 13/11/2022 -->
    </head>
    <body>
        <header>
            <h1>Ejercicios Proyecto Tema 3</h1>
            <h2>Ejercicio 08.php</h2>
        </header>
        <main>
            <article>
                
            <h3>Enunciado: Mostrar la dirección IP del equipo desde el que estás accediendo.</h3>
                    <?php highlight_file("../codigoPHP/ejercicio08.php")?>
            </article>
        </main>
        <footer>
