...
<html lang="en">
    ...
    <body>
        ...
        <main>
            <article>
                <h3>Enunciado: Comprobar librerías utilizadas. Crear librería de funciones.Estudiar como usarla en desarrollo y explotación</h3>
                <?php
                echo '<h4 style="color:orange">Código ejercicio014.php</h4>';
                echo highlight_file("../codigoPHP/ejercicio014.php");
                ?>
            </article>
        </main>
        <footer>
