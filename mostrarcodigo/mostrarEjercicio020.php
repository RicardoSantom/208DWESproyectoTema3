...
<html lang="en">
    <head>
        ...
        <title>Ejercicio 020</title>
    </head>
    <body>
        <header>
            <div class="overlay">
                <h1>Ejercicios Proyecto Tema 3</h1>
                <h2>Ejercicio 020.php</h2>
            </div>
        </header>
        <main>
            <article>
                <h3>Enunciado: Convertir la LibreriaValidacionFormularios.php en una clase ValidacionFormularios.php. 
                    El profesor facilitará a los alumnos la clase
                    AAMMDDValidacionFormularios.php desarrollada en el curso anterior como punto de partida.</h3>
                <?php highlight_file("../core/221024libreriaValidacionFormularios.php");?>
            </article>
        </main>
        <footer>
