...
<html lang="en">
    <head>
        ...
        <title>Ejercicio 022 Tema3</title>
    ...
    <body>
        ...
        <main>
            <article>
                <h3>Enunciado: Construir un formulario para recoger un cuestionario realizado a una persona y mostrar en la misma página las preguntas y las respuestas recogidas.</h3>
                <h4 style="color:orange">Código ejercicio022.php</h4>
                <?php echo highlight_file("../codigoPHP/ejercicio022.php"); ?>
            </article>
        </main>
        <footer>
