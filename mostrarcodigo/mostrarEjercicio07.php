...
<html lang="en">
    <head>
        ...
        <title>Ejercicio 07 Tema3</title>
        <!-- Última actualización 13/11/2022 -->
    </head>
    <body>
        <header>
            <h1>Ejercicios Proyecto Tema 3</h1>
            <h2>Ejercicio 07.php</h2>
        </header>
        <main>
            <article>
            <h3>Enunciado: Mostrar el nombre del fichero que se está ejecutando.</h3>
            <?php highlight_file("../codigoPHP/ejercicio07.php")?>
            </article>
        </main>
        <footer>
