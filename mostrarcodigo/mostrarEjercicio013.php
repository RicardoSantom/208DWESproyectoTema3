...
<html lang="en">
    <head>
        ...
        <title>Ejercicio 013 Tema3</title>
    </head>
    <body>
        <header>
            <h1>Ejercicios Proyecto Tema 3</h1>
            <h2>Ejercicio 013.php</h2>
        </header>
        <main>
            <article>
                
            <h3>Enunciado: Crear una función que cuente el número de visitas a la página actual desde una fecha concreta</h3>
                    <?php highlight_file("../codigoPHP/ejercicio013.php")?>
            </article>
        </main>
        <footer>
